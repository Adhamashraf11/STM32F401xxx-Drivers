/*
 *  Name        : SYSTIC_program.h
 *  Created on  : nov, 2023 
 *  Description : this file contains the programming of SYSTIC prepherail
 *  Version     : v1.0
...
void MSTK_voidSetBusyWait (f32 A_f32TimeInMill)
{
	      ...
	      f32 L_f32TickTimeInMill = 1.0 / (CLOCK_IN_KHZ / 8.0);

    #elif STK_CLOCK_SOURCE == STK_AHB
	      f32 L_f32TickTimeInMill = 1.0 / CLOCK_IN_KHZ;
    #endif

	u32 L_u32NoOfTicks = A_f32TimeInMill / L_f32TickTimeInMill ;
